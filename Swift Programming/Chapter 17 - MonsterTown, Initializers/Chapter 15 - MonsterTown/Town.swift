...
struct Town
{
    ...
    // Changed it to an instance variable
    let region:String
    ...
    // Custom initializer
    // If the variable name is the same as instance variable you need self
    // You can set constants during initialization, as in region
    // The question mark indicates that it is a failable initializer (can return nil)
    ...
    // Must be failable as well since the designated initializer is failable
